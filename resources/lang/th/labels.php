...
return [
    ...
    */
    ...
    'backend' => [
        'access' => [
            'customers' => [
                'create'     => 'ลงทะเบียนผู้ขอใช้บริการ',
                'edit'       => 'แก้ไขข้อมูลผู้ขอใช้บริการ',
                'management' => 'การจัดการผู้ขอใช้บริการ',
                ...
                'services' => [
                    'create'     => 'ลงทะเบียนติดตั้งมิเตอร์วัดน้ำ',
                    'edit'       => 'แก้ไขข้อมูลข้อมูลมิเตอร์น้ำ',
                    'management' => 'การจัดการผู้ขอมิเตอร์วัดน้ำ',

                    'table' => [
                        'meterid' => 'มิเตอร์ไอดี',
                        'meterinit' => 'เลขเริ่มต้น',
                        'address' => 'ที่อยู่ที่ติดตั้งมิเตอร์น้ำ',
                        'status' => 'สถานะ',
                    ],
