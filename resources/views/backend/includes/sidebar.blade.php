        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ active_class(Active::checkUriPattern('admin/dashboard')) }} treeview">
                ...
                <ul class="treeview-menu {{ active_class(Active::checkUriPattern('admin/access/*'), 'menu-open') }}" style="display: none; {{ active_class(Active::checkUriPattern('admin/access/*'), 'display: block;') }}">
                    ...
                    <li class="{{ active_class(Active::checkUriPattern('admin/access/customer*')) }}">
                        <a href="{{ route('admin.access.customer.index') }}">
                            <i class="fa fa-users"></i>
                            <span>{{ trans('labels.backend.access.customers.management') }}</span>
                        </a>
                    </li>
                    @endauth
