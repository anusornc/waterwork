...
@section ('title', trans('labels.backend.access.customers.services.management') . ' | ' . trans('labels.backend.access.customers.services.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.access.customers.services.management') }}
        <small>{{ trans('labels.backend.access.customers.services.edit') }}</small>
    </h1>
@endsection
...
@section('content')
    ...
    {{ Form::model($service, ['route' => ['admin.access.customer.service.update', $customer,$service], 'class' => 'form-horizontal', 'customer' => 'form', 'method' => 'PATCH', 'id' => 'edit-customer-service']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.access.customers.services.edit') }}</h3>
...
@section('after-scripts')
    {{ Html::script('js/backend/access/customers.services.script.js') }}
@endsection